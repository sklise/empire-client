...
var SunCalc, centerOfItem, isDaytime, marked, moment, setTheme, _;
...
isDaytime = function() {
  ...
  return {
    test: sunTimes.sunrise < now && now < sunTimes.sunset,
...
setTheme = function() {
  ...
  if (sunsets.test) {
    ...
    return $('#sunset').text(moment(sunsets.sunset).format("h:mm a"));
  } else {
...
},{"lodash":2,"marked":3,"moment":4,"suncalc":5}],2:[function(require,module,exports){
(function (global){
/**
 * @license
